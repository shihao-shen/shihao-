...
export default hopeTheme({
  ...
  // 网站图标
  logo: "/minions/image12.png",

  // 导航栏上的个人仓库地址
  repo: "https://github.com/shihao-shen",
  ...
  // 页面显示信息
  pageInfo: ["Category", "Tag", "ReadingTime", "Date", "PageView" , "Word", "Author"],
  ...
  // 文章所在仓库
  docsRepo: "https://github.com/shihao-shen/shihao_learning_note",
  ...
  blog: {
    ...
    // 社交媒体
    medias: {
      Gitee: "https://github.com/shihao-shen/",
    },
    // 博客的侧边栏设置
